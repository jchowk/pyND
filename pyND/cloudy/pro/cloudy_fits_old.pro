...
;-
  ...
  FOR ll = 0, num_files-1 DO BEGIN 
    ...
    ;;
    ;;(2): Find  value of J_nu for model:
    ;;
    ;;
    ...
    ;;
    ;;(6): Find average temperature, density
    ;;
    ...
    ;;
    ;;(7): Grab ionization fractions for abundant elements (A=1 to 30)
    ...
    IF strpos(input_string, "Ionisation (over radius)") EQ -1 THEN $
       WHILE strmid(input_string, 0, strlen(text_flag)) NE text_flag DO $
       readf, input_unit, input_string 
